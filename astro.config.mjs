...
export default defineConfig({
  ...
  site: 'https://asisjuridica.com', // Cambia esto por el URL de tu sitio
  ...
  integrations: [
    // Aquí puedes agregar integraciones como preprocesadores CSS, herramientas de despliegue, etc.
  ],

  // Configuración del servidor de desarrollo
  devOptions: {
    port: 3000, // Cambia esto si quieres usar un puerto diferente
    hostname: 'localhost', // Cambia esto si necesitas usar un hostname diferente
